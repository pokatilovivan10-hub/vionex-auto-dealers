...
export const BLOCK_DEFINITIONS = Object.freeze({
  ...
  'hero-auto-dealers': {
    ...
    defaults: {
      ...
      titleLine1: 'Больше тест-драйвов.',
      titleLine2: 'Больше продаж.',
      lead: 'AI и автоматизация превращают интерес в визит, визит — в тест-драйв, тест-драйв — в продажу.',
      ...
      badges: [
        ...
        { title: 'UTM → CRM', text: 'сквозная аналитика', icon: 'data', graphic: '', x: 82, y: 79, width: 194, iconSize: 40, accent: 'violet', visualType: 'standard' },
      ],
      animation: true,
      dataScene: true,
    },
