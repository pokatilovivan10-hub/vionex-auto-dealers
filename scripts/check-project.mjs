...
if (!seed.includes("slug: 'auto-dealers'") || !(await read('src/cms/block-definitions.mjs')).includes("titleLine1: 'Приводим целевых лидов'") || !(await read('src/cms/block-definitions.mjs')).includes("{ title: '+50%', text: 'лидов за 14 дней'")) errors.push('v3.11.0: отсутствуют ясный оффер или ключевые преимущества автодилеров.');
